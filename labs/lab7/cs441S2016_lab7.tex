...
associated with performing uploads. Next, you should review and comment all of the Java source code.  Can you determine
the port used by the ``RMI registry'' that this system starts? Can you find the class that calls {\tt rebind}? What is
the purpose of this method? Finally, you should add one feature to this distributed object-based system.
...
be in a {\tt cs441S2016-<your user name>} repository created for \mbox{this class}.
