...
\begin{document}
\MYTITLE{Laboratory Assignment Five: Using XML-RPC for Client-Server Communication}
...
Finally, you will notice that the {\tt FactorizationXMLClient} and {\tt FactorizationXMLServer} have some ``hard-coded''
