...
% Moreover, the design, implementation, evaluation, documentation, and use of operating are exciting and rewarding
% activities!  
...
and act. Moreover, distributed systems are one of the crucial components that enables people to interact with a
wide range of servers, desktop workstations, and mobile and embedded devices.  As such, efficient and correct operating
systems have the potential to positively influence the lives many of people.  At the start of this class, I
